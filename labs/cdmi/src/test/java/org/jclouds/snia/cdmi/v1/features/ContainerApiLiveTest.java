...
import org.jclouds.snia.cdmi.v1.domain.AccessControlElement;
...
public class ContainerApiLiveTest extends BaseCDMIApiLiveTest {
   ...
   public void testCreateContainer() throws Exception {
      ...
      try {
         ...
         assertNotNull(container.getAccessControlList());
         for (AccessControlElement ace : container.getAccessControlList()) {
            logger.info(ace.toString());
         }
   ...
   public void testGetContainer() throws Exception {
      ...
      try {
         ...
         if (containerNesting) {
            ...
            assertEquals(container.getObjectName(), containerName+"/");
            assertEquals(container.getParentURI(), "/");
            assertEquals(container.getAccessControlList().size(), 3);
